...
def send_data():
    try:
        ...
        producer = KafkaProducer(bootstrap_servers=['kafkahost2', 'kafkahost2', 'kafkahost2']) 
        
        
        with open('/usy/versioncheck/liberty_all_versions.txt') as f:
            readed_line=str()
            lines = f.readlines()
            for line in lines:
        ...
        print("---")
        print("Liberty sunucu versiyonlari icin data gonderimi tamamlanmistir. ")
    except:
